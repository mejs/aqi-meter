...
Vlado's fork: added conversion to AQI
...
def read_nova_dust_sensor(device='/dev/ttyUSB0'):
    ...
    return {'PM10': pm10, 'PM2_5': pm25, 'AQI': myaqi}
...
def main():
    ...
    logging.info('PM10=% 3.1f ug/m^3 PM2.5=% 3.1f ug/m^3 AQI=% 3.1f', data['PM10'], data['PM2_5'], data['AQI'])

    if args.csv:
        field_list = ['date', 'PM10', 'PM2_5', 'AQI']
